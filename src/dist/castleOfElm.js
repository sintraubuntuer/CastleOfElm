...
var _user$project$GameModel$checkWallImg = function (walltype) {
	var getsrc = function (side) {
		var _p0 = side;
		if (_p0.ctor === 'Flat') {
			return 'flat';
		} else {
	...
	var r = getsrc(walltype.r);
	var l = getsrc(walltype.l);
	var u = getsrc(walltype.u);
	var d = getsrc(walltype.d);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'img/walls/',
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'-',
								A2(_elm_lang$core$Basics_ops['++'], d, '.png'))))))));
};
var _user$project$GameModel$checkBgImg = function (bgtype) {
	var _p1 = bgtype;
	switch (_p1.ctor) {
		case 'Floor':
			return 'img/floor/floor_01.png';
		case 'Wall':
			return 'img/walls/wall.png';
		case 'Water':
			return 'img/water/water_01.png';
		default:
			return _user$project$GameModel$checkWallImg(_p1._0);
	}
};
var _user$project$GameModel$getListIdx = F2(
	function (idx, list) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, idx, list));
	});
var _user$project$GameModel$tileSize = 64;
var _user$project$GameModel$displayTile = function (tile) {
	var src = function () {
		var _p2 = tile;
		if (_p2.ctor === 'BackGround') {
			return _user$project$GameModel$checkBgImg(_p2._0);
		} else {
			return '';
		}
	}();
	return A3(_evancz$elm_graphics$Element$image, _user$project$GameModel$tileSize, _user$project$GameModel$tileSize, src);
};
var _user$project$GameModel$gridSize = 15;
var _user$project$GameModel$displayTileAtCoordinates = function (_p3) {
	var _p4 = _p3;
	var position = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toFloat(_user$project$GameModel$tileSize) * (_elm_lang$core$Basics$toFloat(_p4._1) - ((_elm_lang$core$Basics$toFloat(_user$project$GameModel$gridSize) - 1) / 2)),
		_1: (-1 * _elm_lang$core$Basics$toFloat(_user$project$GameModel$tileSize)) * (_elm_lang$core$Basics$toFloat(_p4._2) - ((_elm_lang$core$Basics$toFloat(_user$project$GameModel$gridSize) - 1) / 2))
	};
	return A2(
		_evancz$elm_graphics$Collage$move,
		position,
		_evancz$elm_graphics$Collage$toForm(
			_user$project$GameModel$displayTile(_p4._0)));
};
var _user$project$GameModel$displayTileAtIndex = F2(
	function (index, tile) {
		var x = A2(_elm_lang$core$Basics_ops['%'], index, _user$project$GameModel$gridSize);
		var y = (index / _user$project$GameModel$gridSize) | 0;
		return _user$project$GameModel$displayTileAtCoordinates(
			{ctor: '_Tuple3', _0: tile, _1: x, _2: y});
	});
var _user$project$GameModel$displayGrid = F3(
	function (frame, pcCoords, g) {
		var tiles = A2(_elm_lang$core$List$indexedMap, _user$project$GameModel$displayTileAtIndex, g);
		return tiles;
	});
var _user$project$GameModel$gridWidth = _elm_lang$core$Basics$toFloat(_user$project$GameModel$gridSize) * _elm_lang$core$Basics$toFloat(_user$project$GameModel$tileSize);
var _user$project$GameModel$getTileIdxFromPosition = function (_p5) {
	var _p6 = _p5;
	var y_tile = 8 - _elm_lang$core$Basics$round(_p6._1);
	var x_tile = _elm_lang$core$Basics$round(_p6._0) + 7;
	return ((y_tile - 1) * _user$project$GameModel$gridSize) + x_tile;
};
var _user$project$GameModel$Character = F3(
	function (a, b, c) {
		return {x: a, y: b, dir: c};
	});
var _user$project$GameModel$WallTile = F4(
	function (a, b, c, d) {
		return {r: a, l: b, u: c, d: d};
	});
var _user$project$GameModel$Model = F3(
	function (a, b, c) {
		return {grid: a, gridSide: b, pc: c};
	});
var _user$project$GameModel$None = {ctor: 'None'};
var _user$project$GameModel$Down = {ctor: 'Down'};
var _user$project$GameModel$Up = {ctor: 'Up'};
var _user$project$GameModel$Right = {ctor: 'Right'};
var _user$project$GameModel$Left = {ctor: 'Left'};
var _user$project$GameModel$Move = function (a) {
	return {ctor: 'Move', _0: a};
};
var _user$project$GameModel$NoOp = {ctor: 'NoOp'};
var _user$project$GameModel$Water = {ctor: 'Water'};
var _user$project$GameModel$Wall = {ctor: 'Wall'};
var _user$project$GameModel$WallOver = function (a) {
	return {ctor: 'WallOver', _0: a};
};
var _user$project$GameModel$Floor = {ctor: 'Floor'};
var _user$project$GameModel$Main = {ctor: 'Main'};
var _user$project$GameModel$Shadow = function (a) {
	return {ctor: 'Shadow', _0: a};
};
var _user$project$GameModel$BackGround = function (a) {
	return {ctor: 'BackGround', _0: a};
};
var _user$project$GameModel$Column = {ctor: 'Column'};
var _user$project$GameModel$Flag = function (a) {
	return {ctor: 'Flag', _0: a};
};
var _user$project$GameModel$Lever = {ctor: 'Lever'};
var _user$project$GameModel$Box = {ctor: 'Box'};
var _user$project$GameModel$Money = {ctor: 'Money'};
var _user$project$GameModel$Key = {ctor: 'Key'};
var _user$project$GameModel$Skull = {ctor: 'Skull'};
var _user$project$GameModel$Chest = function (a) {
	return {ctor: 'Chest', _0: a};
};
var _user$project$GameModel$Door = function (a) {
	return {ctor: 'Door', _0: a};
};
var _user$project$GameModel$Big = {ctor: 'Big'};
var _user$project$GameModel$Small = {ctor: 'Small'};
var _user$project$GameModel$Fine = {ctor: 'Fine'};
var _user$project$GameModel$Ruined = {ctor: 'Ruined'};
var _user$project$GameModel$Empty = {ctor: 'Empty'};
var _user$project$GameModel$Flat = {ctor: 'Flat'};
var _user$project$GameModel$ffff = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Flat};
var _user$project$GameModel$efef = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Flat};
var _user$project$GameModel$feef = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Empty, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Flat};
var _user$project$GameModel$eeff = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Empty, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Flat};
var _user$project$GameModel$fefe = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Empty, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Empty};
var _user$project$GameModel$ffee = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Empty};
var _user$project$GameModel$effe = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Empty};
var _user$project$GameModel$feee = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Empty, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Empty};
var _user$project$GameModel$eefe = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Empty, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Empty};
var _user$project$GameModel$efff = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Flat};
var _user$project$GameModel$ffef = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Flat};
var _user$project$GameModel$efee = {r: _user$project$GameModel$Empty, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Empty, d: _user$project$GameModel$Empty};
var _user$project$GameModel$fffe = {r: _user$project$GameModel$Flat, u: _user$project$GameModel$Flat, l: _user$project$GameModel$Flat, d: _user$project$GameModel$Empty};
var _user$project$GameModel$mainGrid = {
	ctor: '::',
	_0: _user$project$GameModel$BackGround(
		_user$project$GameModel$WallOver(_user$project$GameModel$ffee)),
	_1: {
		ctor: '::',
		_0: _user$project$GameModel$BackGround(
			_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
		_1: {
			ctor: '::',
			_0: _user$project$GameModel$BackGround(
				_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _user$project$GameModel$BackGround(
																_user$project$GameModel$WallOver(_user$project$GameModel$effe)),
															_1: {
																ctor: '::',
																_0: _user$project$GameModel$BackGround(
																	_user$project$GameModel$WallOver(_user$project$GameModel$fefe)),
																_1: {
																	ctor: '::',
																	_0: _user$project$GameModel$BackGround(_user$project$GameModel$Wall),
																	_1: {
																		ctor: '::',
																		_0: _user$project$GameModel$BackGround(_user$project$GameModel$Wall),
																		_1: {
																												...
																												_1: {
																													...
																													_1: {
																														...
																														_1: {
																															...
																															_1: {
																																ctor: '::',
																																_0: _user$project$GameModel$BackGround(_user$project$GameModel$Floor),
																																_1: {
																																	ctor: '::',
																																	_0: _user$project$GameModel$BackGround(_user$project$GameModel$Floor),
																																	_1: {
																																																	...
																																																	_1: {
																																																		...
																																																		_1: {
																																																			...
																																																			_1: {
																																																				ctor: '::',
																																																				_0: _user$project$GameModel$BackGround(
																																																					_user$project$GameModel$WallOver(_user$project$GameModel$fffe)),
																																																				_1: {
																																																					ctor: '::',
																																																					_0: _user$project$GameModel$BackGround(_user$project$GameModel$Floor),
																																																					_1: {
																																																																									...
																																																																									_1: {
																																																																										...
																																																																										_1: {
																																																																											...
																																																																											_1: {
																																																																												ctor: '::',
																																																																												_0: _user$project$GameModel$BackGround(
																																																																													_user$project$GameModel$WallOver(_user$project$GameModel$feee)),
																																																																												_1: {
																																																																													ctor: '::',
																																																																													_0: _user$project$GameModel$BackGround(
																																																																														_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
																																																																													_1: {
																																																																														...
																																																																														_1: {
																																																																															ctor: '::',
																																																																															_0: _user$project$GameModel$BackGround(
																																																																																_user$project$GameModel$WallOver(_user$project$GameModel$efee)),
																																																																															_1: {
																																																																																ctor: '::',
																																																																																_0: _user$project$GameModel$BackGround(
																																																																																	_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
																																																																																_1: {
																																																																																	...
																																																																																	_1: {
																																																																																		ctor: '::',
																																																																																		_0: _user$project$GameModel$BackGround(
																																																																																			_user$project$GameModel$WallOver(_user$project$GameModel$eeff)),
																																																																																		_1: {
																																																																																			ctor: '::',
																																																																																			_0: _user$project$GameModel$BackGround(_user$project$GameModel$Floor),
																																																																																			_1: {
																																																																																				...
																																																																																				_1: {
																																																																																					...
																																																																																					_1: {
																																																																																						ctor: '::',
																																																																																						_0: _user$project$GameModel$BackGround(
																																																																																							_user$project$GameModel$WallOver(_user$project$GameModel$ffef)),
																																																																																						_1: {
																																																																																							ctor: '::',
																																																																																							_0: _user$project$GameModel$BackGround(
																																																																																								_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
																																																																																							_1: {
																																																																																								...
																																																																																								_1: {
																																																																																									...
																																																																																									_1: {
																																																																																										ctor: '::',
																																																																																										_0: _user$project$GameModel$BackGround(
																																																																																											_user$project$GameModel$WallOver(_user$project$GameModel$eefe)),
																																																																																										_1: {
																																																																																											ctor: '::',
																																																																																											_0: _user$project$GameModel$BackGround(
																																																																																												_user$project$GameModel$WallOver(_user$project$GameModel$fefe)),
																																																																																																																																								...
																																																																																																																																								_1: {
																																																																																																																																									...
																																																																																																																																									_1: {
																																																																																																																																										...
																																																																																																																																										_1: {
																																																																																																																																											ctor: '::',
																																																																																																																																											_0: _user$project$GameModel$BackGround(
																																																																																																																																												_user$project$GameModel$WallOver(_user$project$GameModel$feef)),
																																																																																																																																											_1: {
																																																																																																																																												ctor: '::',
																																																																																																																																												_0: _user$project$GameModel$BackGround(
																																																																																																																																													_user$project$GameModel$WallOver(_user$project$GameModel$efef)),
																																																																																																																																												_1: {
																																																																																																																																													ctor: '::',
																																																																																																																																													_0: _user$project$GameModel$BackGround(
																																																																																																																																														_user$project$GameModel$WallOver(_user$project$GameModel$efff)),
																																																																																																																																													_1: {
																																																																																																																																														ctor: '::',
																																																																																																																																														_0: _user$project$GameModel$BackGround(_user$project$GameModel$Floor),
																																																																																																																																														_1: {
																																																																																																																																																																																																															...
																																																																																																																																																																																																															_1: {
																																																																																																																																																																																																																...
																																																																																																																																																																																																																_1: {
																																																																																																																																																																																																																	...
																																																																																																																																																																																																																	_1: {
																																																																																																																																																																																																																		...
																																																																																																																																																																																																																		_1: {
																																																																																																																																																																																																																			ctor: '::',
																																																																																																																																																																																																																			_0: _user$project$GameModel$BackGround(_user$project$GameModel$Water),
																																																																																																																																																																																																																			_1: {
																																																																																																																																																																																																																				ctor: '::',
																																																																																																																																																																																																																				_0: _user$project$GameModel$BackGround(_user$project$GameModel$Water),
																																																																																																																																																																																																																				_1: {
...
var _user$project$GameModel$Won = {ctor: 'Won'};
var _user$project$GameModel$GameOver = {ctor: 'GameOver'};
var _user$project$GameModel$InProgress = {ctor: 'InProgress'};

var _user$project$Main$fromCode = function (keyCode) {
	var _p0 = keyCode;
	switch (_p0) {
		case 79:
			return _user$project$GameModel$Left;
		case 37:
			return _user$project$GameModel$Left;
		case 80:
			return _user$project$GameModel$Right;
		case 39:
			return _user$project$GameModel$Right;
		case 81:
			return _user$project$GameModel$Up;
		case 38:
			return _user$project$GameModel$Up;
		case 40:
			return _user$project$GameModel$Down;
		case 65:
			return _user$project$GameModel$Down;
		default:
			return _user$project$GameModel$None;
	}
};
var _user$project$Main$matchToSide = F2(
	function (frame, side) {
		var _p1 = frame;
		var w = _p1._0;
		var h = _p1._1;
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Debug$log, 'tW', tW),
			_1: A2(_elm_lang$core$Debug$log, 'tH', tH)
		};
	});
var _user$project$Main$view = function (model) {
	var dir = function () {
		var _p2 = model.pc.dir;
		switch (_p2.ctor) {
			case 'Left':
				return 'left';
			case 'Right':
	...
	var src = A2(
		_elm_lang$core$Basics_ops['++'],
		'img/pc/',
		A2(_elm_lang$core$Basics_ops['++'], dir, '.png'));
	var frame = {ctor: '_Tuple2', _0: 600, _1: 600};
	var tileSide = 64;
	var pcImage = A3(_evancz$elm_graphics$Element$image, tileSide, tileSide, src);
	var _p3 = A2(
		_user$project$Main$matchToSide,
		A2(_elm_lang$core$Debug$log, 'win', frame),
		tileSide);
	var tW = _p3._0;
	var tH = _p3._1;
	var tWSide = tW * tileSide;
	var tHSide = tH * tileSide;
	var pcPos = {ctor: '_Tuple2', _0: model.pc.x * tileSide, _1: tileSide * model.pc.y};
	var theelement = A3(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			A3(
				_user$project$GameModel$displayGrid,
				{ctor: '_Tuple2', _0: tW, _1: tH},
				pcPos,
				_user$project$GameModel$mainGrid),
			{
				ctor: '::',
				_0: A2(
					_evancz$elm_graphics$Collage$move,
					...
					A2(
						...
						'pc',
						_evancz$elm_graphics$Collage$toForm(pcImage))),
				_1: {ctor: '[]'}
			}));
	return _evancz$elm_graphics$Element$toHtml(theelement);
};
var _user$project$Main$movepc = F2(
	function (dir, model) {
		var updatePc = F2(
			function (pc, dir) {
				var _p4 = dir;
				switch (_p4.ctor) {
					case 'Up':
						return _elm_lang$core$Native_Utils.update(
							pc,
							{y: pc.y + 1, dir: _user$project$GameModel$Up});
					case 'Down':
						return _elm_lang$core$Native_Utils.update(
							pc,
							{y: pc.y - 1, dir: _user$project$GameModel$Down});
					case 'Left':
						return _elm_lang$core$Native_Utils.update(
							pc,
							{x: pc.x - 1, dir: _user$project$GameModel$Left});
					case 'Right':
						return _elm_lang$core$Native_Utils.update(
							pc,
							{x: pc.x + 1, dir: _user$project$GameModel$Right});
					default:
						return pc;
				}
			});
		var checkPc = F2(
			function ($default, pc) {
				var idx = A2(
					_elm_lang$core$Debug$log,
					'idx',
					_user$project$GameModel$getTileIdxFromPosition(
						{ctor: '_Tuple2', _0: pc.x, _1: pc.y}));
				var tile = A2(
					_elm_lang$core$Debug$log,
					'tile',
					A2(_user$project$GameModel$getListIdx, idx, model.grid));
				var y = A2(_elm_lang$core$Debug$log, 'pc y', pc.y);
				var x = A2(_elm_lang$core$Debug$log, 'pc x', pc.x);
				var _p5 = tile;
				if (_p5.ctor === 'Nothing') {
					return pc;
				} else {
					return _elm_lang$core$Native_Utils.eq(
						_p5._0,
						_user$project$GameModel$BackGround(_user$project$GameModel$Floor)) ? pc : $default;
				}
			});
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p6.ctor === 'Noop') {
			...
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Main$movepc, _p6._0, model),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Main$pcState = {x: 0, y: 0, dir: _user$project$GameModel$Right};
var _user$project$Main$initialModel = {grid: _user$project$GameModel$mainGrid, gridSide: _user$project$GameModel$gridWidth, pc: _user$project$Main$pcState};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$keyboard$Keyboard$downs(
				function (kcode) {
					return _user$project$Main$KeyPress(
						_user$project$Main$fromCode(kcode));
				}),
			_1: {ctor: '[]'}
		});
};
